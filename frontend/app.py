...
def render_main_content():
    ...
    if st.session_state.get("password_correct", False):
        ...
        st.write(
            '3) Чтобы посмотреть статистику в разрезе измерений или за определенный промежуток времени, нужно выбрать действие на странице "Посмотреть статистику" и заполнить все поля.')
