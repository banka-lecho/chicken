...
def clicked_toggle(button, value_count):
...
if df.shape[0] == 0:
    ...
    if response_camera.status_code == 200:
        ...
        if st.session_state.clicked[1]:
            ...
            if st.sidebar.toggle('ПУСК', on_change=clicked_toggle, args=[2, count_chickens]):
                count_chickens = helper.run_counting(model, stream_address)
